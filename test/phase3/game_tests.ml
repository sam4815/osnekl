...
let%expect_test "Testing [Game.step] with wall collision..." =
  let t =
    create_game_with_apple_exn ~height:10 ~width:10 ~initial_snake_length:3
      ~amount_to_grow:3
  ...
  [%expect
    {|
        ((snake
         ...
         (apple ((location ((col 1) (row 8))))) (game_state In_progress) (score 0)
         (height 10) (width 10) (amount_to_grow 3)) |}];
  step_n_times t 1;
  Stdio.printf !"%{sexp: t}\n%!" t;
  [%expect
    {|
        ((snake
         ...
         (game_state (Game_over "Wall collision")) (score 0) (height 10) (width 10)
         (amount_to_grow 3)) |}]
...
let%expect_test "Testing [Game.step] with apple consumption..." =
  ...
  step_n_times t 9;
  create_apple_and_update_game_exn t
  ...
  [%expect
    {|
        ((snake
         ...
         (apple ((location ((col 6) (row 7))))) (game_state In_progress) (score 1)
         (height 10) (width 10) (amount_to_grow 3)) |}];
  ...
  [%expect
    {|
        ((snake
         ...
         (game_state (Game_over "Self collision")) (score 1) (height 10) (width 10)
         (amount_to_grow 3)) |}]

let%expect_test "Testing [Game.step] with game winning..." =
  let t =
    create_game_with_apple_exn ~height:2 ~width:3 ~initial_snake_length:3
      ~amount_to_grow:3
          ...
          ((direction Left) (extensions_remaining 4)
           (locations
            (((col 0) (row 1)) ((col 1) (row 1)) ((col 2) (row 1)) ((col 2) (row 0))
             ((col 1) (row 0))))))
         (apple ((location ((col 0) (row 0))))) (game_state In_progress) (score 2)
  ...
  [%expect
    {|
        ((snake
         ...
         (apple ((location ((col 0) (row 0))))) (game_state Win) (score 2) (height 2)
